...
import com.prince.bookhub.activity.database.BookDatabase
import com.prince.bookhub.activity.database.BookEntity
import com.prince.bookhub.activity.util.ConnectionManager
import com.prince.bookhub.model.Book
  //import com.prince.bookhub.util.ConnectionManager
...
class DescriptionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (ConnectionManager().checkConnectivityManager(this@DescriptionActivity)) {
